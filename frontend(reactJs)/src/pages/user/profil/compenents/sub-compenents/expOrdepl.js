    ...
    return (<div  >
        ...
        <Model id={title} title={<FontAwesomeIcon icon={faPlus} />}>
            <Formik
                ...
                onSubmit={fields => {
                    // const info = oneFiel.info
                    fields.title=fields.title.replace(/[^A-Za-z-1-2 _]/ig, '')
                    fields.content= fields.content.replace(/[^A-Za-z-1-2 _]/ig, '')
                    fields.location=fields.location.replace(/[^A-Za-z-1-2 _]/ig, '')
